...
<body>
	<div id="watermark">
		...
		@endphp
		<img style="position: absolute; margin-top: 65%;margin-left: 42%;" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->backgroundColor(251, 245, 231)->size(150)->merge('https://downloads.tesseractgnit.com/img/tesseract_transparent.png', .25, true)->errorCorrection('H')->generate($gen)) !!} ">		
