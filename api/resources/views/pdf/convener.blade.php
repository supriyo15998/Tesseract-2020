...
<body>
	<div id="watermark">
		<div class="name">{{ $convener->name }}</div>
		@php
			$gen = "https://www.tesseractgnit.com/validate/certificate/" . base_convert(4+1000, 10, 16) . "-" . base_convert($convener->id+100000, 10, 16);
		@endphp
		...
		<img src="img/certificates/final/Convenor-min.jpg" height="800" width="1150">
	</div>
</body>
</html>