...
<body>
	<div id="watermark">
		<div class="name">{{ ucwords(strtolower($coordinator->name)) }}</div>
		@php
			$gen = "https://www.tesseractgnit.com/validate/certificate/" . base_convert(6+1000, 10, 16) . "-" . base_convert($coordinator->id+100000, 10, 16);
		@endphp
		...
		<img src="img/certificates/final/co_ordinator_certificate_min.jpg" height="800" width="1150">
	</div>
</body>
</html>