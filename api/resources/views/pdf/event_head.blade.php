...
<body>
	<div id="watermark">
		<div class="name">{{ ucwords(strtolower($eventHead->name)) }}</div>
		@php
			$gen = "https://www.tesseractgnit.com/validate/certificate/" . base_convert(5+1000, 10, 16) . "-" . base_convert($eventHead->id+100000, 10, 16);
		@endphp
		...
		<img src="img/certificates/final/event_head-min.jpg" height="800" width="1150">
	</div>
</body>
</html>