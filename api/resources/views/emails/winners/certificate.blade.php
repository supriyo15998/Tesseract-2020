...
Note: The signatures contained in these documents/certificates is confidential, privileged and only for the authenticity. You are hereby notified that any use of these signatures without permission is strictly prohibited.
Regards,
Team Tesseract
Thanks,<br>
{{ config('app.name') }}
