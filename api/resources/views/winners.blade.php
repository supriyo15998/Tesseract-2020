...
<html>
<head>
	<title>Winners | Tesseract 2020</title>
...
<body>
    ...
    <div class="container">
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/second.jpg') }}" alt="card image"></p>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/first.jpg') }}" alt="card image"></p>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/third.jpg') }}" alt="card image"></p>
        ...
        <h5 class="section-title h3">Web Art</h5>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/first.jpg') }}" alt="card image"></p>
                                    <h4 class="card-title">Team: codex_noob</h4>
                                    <h5 class="card-text">Leader: Ishan Chaudhuri</h5>
                                    <p class="card-text">College: Rcc Institute of Information Technology</p>
                                </div>
                            </div>
                        </div>
        ...
        <h1 class="section-title h1">Gaming</h1>
        <h5 class="section-title h3">Pubg Mobile (Squad)</h5>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
        ...
        <h5 class="section-title h3">Pubg Mobile (Solo)</h5>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/maxkills.jpg') }}" alt="card image"></p>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/wwcd.jpg') }}" alt="card image"></p>
                                    <h5 class="card-text">Player: Koustav Dutta</h5>
                                    <p class="card-text">College: GNIT</p>
                                </div>
                            </div>
        ...
        <h5 class="section-title h3">Need For Speed Most Wanted</h5>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/first.jpg') }}" alt="card image"></p>
                                    <h5 class="card-text">Player: SAYANDIP GHOSH</h5>
                                    <p class="card-text">College: Narula Institute Of Technology</p>
                                </div>
                            </div>
                        </div>
        ...
        <h5 class="section-title h3">Fifa 11</h5>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/first.jpg') }}" alt="card image"></p>
                                    <h5 class="card-text">Player: Pushpal Bag</h5>
                                    <p class="card-text">College: Shibpur Dinobundhoo Institution (College)</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <h1 class="section-title h1">Model Display</h1>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/third.jpg') }}" alt="card image"></p>
                                    <h4 class="card-title">Team: Greenholics</h4>
                                    <h5 class="card-text">Leader: Subhajit Sanyal</h5>
                                    <p class="card-text">College: Guru Nanak Institute Of Technology</p>
                                </div>
                            </div>
                        </div>
        ...
        <h1 class="section-title h1">Miscellaneous</h1>
        <h5 class="section-title h3">Debate</h5>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/first.jpg') }}" alt="card image"></p>
                                    <h4 class="card-title">Player: Prasoon Thakur</h4>
                                    <p class="card-text">College: Guru Nanak Institute of Technology</p>
                                </div>
                            </div>
                        </div>
        ...
        <h5 class="section-title h3">Poster Presentation</h5>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/third.jpg') }}" alt="card image"></p>
                                    <h4 class="card-title">Player: Sanjay Biswas</h4>
                                    <p class="card-text">College: Guru Nanak Institute of Technology</p>
                                </div>
                            </div>
                        </div>
        ...
        <h5 class="section-title h3">Photography</h5>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/third.jpg') }}" alt="card image"></p>
                                    <h4 class="card-title">Player: Tatan Ghosh</h4>
                                    <p class="card-text">College: Guru Nanak Institute of Technology</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/first.jpg') }}" alt="card image"></p>
                                    <h4 class="card-title">Team: Re-Moved</h4>
                                    <h5 class="card-text">Leader: Ayon Maji</h5>
                                    <p class="card-text">College: Guru Nanak Institute of Technology</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/third.jpg') }}" alt="card image"></p>
                                    <h4 class="card-title">Team: Flop-Py</h4>
                                    <h5 class="card-text">Leader: Sayon Roy</h5>
                                    <p class="card-text">College: Asutosh College</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <h1 class="section-title h1">Naveen Vidyarthi</h1>
        <div class="row">
            <!-- Team member -->
            <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="{{ asset('img/winners/first.jpg') }}" alt="card image"></p>
                                    <h4 class="card-title">Team: Dream Teachies</h4>
                                    <h5 class="card-text">Leader: Souvik Mondal</h5>
                                    <p class="card-text">College: Guru Nanak Institute of Technology</p>
                                </div>
                            </div>
                        </div>
